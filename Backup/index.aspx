...
<script runat="server">
      ...
      Sub GetMachineName()
         ...
         Response.Write("http://" & ServerName & ".win.hostgator.com")
...
<div id="content"><a href="/webmail" target="_blank"></a><br />
  ...
  <tr>
    ...
    <td valign='middle' class='contentlinks'><a href='<% GetMachineName %>:8443/' target='_blank'>Plesk Login</a></td>
    <td align="right"><img src="http://www.hostgatorsupport.com/images/mail2.png" alt="webmail" width="51" height="36" /></td>
    <td valign='middle' class='contentlinks'><a href='<% GetMachineName %>:9998/' target='_blank'>Webmail Login</a></td>
    </tr>
